...
- [Cordum](https://github.com/cordum-io/cordum) - Safety-first agent orchestration platform with runtime security for LLM agents. Pre-dispatch policy evaluation (deny/escalate/allow), 2-phase output scanning (PII, secrets, injection), multi-tenant isolation, and full audit trail.
