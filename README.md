...
- [Cordum](https://github.com/cordum-io/cordum): safety-first control plane for autonomous AI agents with pre-dispatch policy evaluation (deny/escalate/allow), 2-phase output scanning (PII, secrets, injection), multi-tenant isolation, and full audit trail. (BUSL-1.1, converts to Apache 2.0 in 2029) \![GitHub Repo stars](https://img.shields.io/github/stars/cordum-io/cordum?style=social)
